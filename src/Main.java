...
public class Main {
    ...
    public static void main(String[] args) throws ModelException {
        System.out.println("Результат: " + calc(init().nextLine()));

//        System.out.print("Input: 1 - 2, Output: " + calc("1 - 2"));
//        System.out.println();
//        System.out.print("Input: 7 * 7, Output: " + calc("7 * 7"));
//        System.out.println();
//        System.out.print("Input: VI / III, Output: " + calc("VI / III"));
//        System.out.println();

//        System.out.print("Input: 3 + II, Output: " + calc("3 + II"));
//        System.out.println();
